...
if [[ ${PV} != 9999 ]]; then
	SRC_URI="https://github.com/coreos/grub/archive/${PV}.tar.gz"
	S=${WORKDIR}/grub-${PV}
	KEYWORDS="amd64 ~arm64 x86"
else
	inherit git-r3
	EGIT_REPO_URI="https://github.com/coreos/grub.git"
fi
...
DESCRIPTION="GNU GRUB boot loader with TPM support"
HOMEPAGE="https://github.com/coreos/grub/"
